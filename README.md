...
## 🛡️ The Chaos: Defending Against My Friends
...
The minute the link went live, my friends and wing-mates immediately stopped playing the game normally and started trying to hack it. They were opening the browser console, trying to spoof score variables, inspecting the network requests, and doing everything they could to bypass the game and find the reveal image hidden in the code.
